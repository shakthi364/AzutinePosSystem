 ...
 * @author binar
 */
public class Select_Empoyee extends javax.swing.JDialog {

    /**
     * Creates new form Select_Empoyee
     */
    public Select_Empoyee(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        textField1.setHintText("Search User");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Select_Empoyee.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Select_Empoyee dialog = new Select_Empoyee(new javax.swing.JFrame(), true);
